...
import BoscoLibrary.springbootlibrary.dao.ReviewRepository;
...
public class AdminService {
    ...
    public void postBook(AddBookRequest addBookRequest){
        ...
        book.setCopies((long) addBookRequest.getCopies());
        book.setCopiesAvailable((long) addBookRequest.getCopies());
