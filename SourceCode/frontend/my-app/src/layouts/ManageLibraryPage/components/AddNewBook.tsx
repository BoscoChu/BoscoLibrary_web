...
export const AddNewBook = () =>{
        ...
        async function submitNewBook(){
            ...
            if (authState?.isAuthenticated && title!=='' && author!=='' && category!=='Category' && description!=='' && copies >= 0) {
                ...
                const submitNewBookResopnse = await fetch(url, requestOptions);
                if (!submitNewBookResopnse.ok) {
                    ...
                    <div className="card">
                         ...
                         <div className="card-body">
                                <form method="POST">
                                    ...
                                    <textarea className="form-control" id="exampleFormControlTextarea1"  rows={3} onChange={e => setDescription(e.target.value)} 
                                    value={description}>
