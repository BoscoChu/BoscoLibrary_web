...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any}> = (props, key) => {
    ...
    useEffect(() => {
        ...
        async function increaseQuantity() {
            ...
            const quantityUpdateResopnse = await fetch(url, requestOptions);
            if (!quantityUpdateResopnse.ok) {
        ...
        async function deleteBook() {
            ...
            const UpdateResopnse = await fetch(url, requestOptions);
            if (!UpdateResopnse.ok) {
                throw new Error('Something went wrong!');
            }
            props.deleteBook();
