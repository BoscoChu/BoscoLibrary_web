...
isReviewLeft:Boolean, submitReview:any
        ...
        function bottonReview(){
            if(props.isAuthenticated && !props.isReviewLeft){           //if the user logged in
                return (<p><LeaveAReview submitReview={props.submitReview}/></p>)
            }
            else if (props.isAuthenticated && props.isReviewLeft){          //if the user logged in and he already writted the review
                return(
                <p>
